...
public class MusicAdapter extends ArrayAdapter<MusicFile> implements View.OnClickListener, View.OnLongClickListener {
    ...
    public MusicAdapter(Activity context, LinkedList<MusicFile> musicData, ArrayList<User>user) {
        super(context, R.layout.music_list, musicData);
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        favButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                databaseReference.child(id).setValue(musicData.get(position));
                displayToast("Added to Favorite List");
